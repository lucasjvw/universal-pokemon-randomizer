...
public class Gen1RomHandler extends AbstractGBCRomHandler {
    ...
    private void loadBasicPokeStats(Pokemon pkmn, int offset) {
        ...
        pkmn.setSpatk(pkmn.getSpecial());
        pkmn.setSpdef(pkmn.getSpecial());
        // Type
    ...
    public boolean setStaticPokemon(List<Pokemon> staticPokemon) {
        ...
        for (int i = 0; i < singleSize; i++) {
            rom[romEntry.staticPokemonSingle.get(i)] = (byte) pokeNumToRBYTable[staticPokemon.get(i).getNumber()];
        }

        // Game corner
        for (int i = 0; i < gcSize; i++) {
            byte pokeNum = (byte) pokeNumToRBYTable[staticPokemon.get(i + singleSize).getNumber()];
        ...
        // Ghost Marowak
        byte maroNum = (byte) pokeNumToRBYTable[staticPokemon.get(singleSize + gcSize).getNumber()];
    ...
    public void setTMHMCompatibility(Map<Pokemon, boolean[]> compatData) {
        ...
        for (Map.Entry<Pokemon, boolean[]> compatEntry : compatData.entrySet()) {
            ...
            int baseStatsOffset = (romEntry.isYellow || pkmn.getNumber() != Gen1Constants.mewIndex) ? (pokeStatsOffset + (pkmn.getNumber() - 1)
    ...
    public BufferedImage getMascotImage() {
        ...
        // using pokered code
        if (mascot.getNumber() == 151 && !romEntry.isYellow) {
            // Mew
            fsBank = 1;
        } else if (idx < 0x1F) {
            fsBank = 0x9;
